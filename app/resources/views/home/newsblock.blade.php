    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h5 class="sec_sub_title">{{__('Новости')}}</h5>
                <h2 class="sec_title">
                 {{__('  Последние новости перейдите чтобы  узнать больше')}}
                </h2>
            </div>
        </div>
                    ...
                    <div class="blog_loop_1 clearfix">
                        ...
                        <div class="col-lg-6 col-sm-6 noPadding">
                            <div class="bl1_details text-left bl1_one">
                                ...
                                <a href="{{route('news.show',['id' => $item->id, 'slug' => $item->slug])}}" class="ast_learnmore">{{_('Читать далее')}}<i class="arrowicon-arrows-2"></i></a>
                            </div>
                        </div>
                    </div>
                        @elseif($num == 1)
                    <div class="blog_loop_1 clearfix">
                        ...
                        <div class="col-lg-6 col-sm-6 noPadding">
                            <div class="bl1_details text-right bl1_two">
                                ...
                                <a href="{{route('news.show',['id' => $item->id, 'slug' => $item->slug])}}" class="ast_learnmore iconinleft"><i class="arrowicon-arrows-2"></i>{{_('Читать далее')}}</a>
                            </div>
                        </div>
                    ...
                    <div class="blog_loop_1 clearfix">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-6 noPadding">
                            <div class="bl1_details text-center bl1_three">
                                ...
                                <a href="{{route('news.show',['id' => $item->id, 'slug' => $item->slug])}}" class="ast_learnmore">Читать далее<i class="arrowicon-arrows-2"></i></a>
                            </div>
                        </div>
                    </div>
                    @endif
