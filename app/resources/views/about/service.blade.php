    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h5 class="sec_sub_title">{{__('Наш сервис')}}</h5>
                <h2 class="sec_title">
                    {{__('Избавляет от головной, кадровой боли')}}
                </h2>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="st3_tab_content">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-sm-5">
                                        ...
                                        <a href="tel:{{ preg_replace("/[^a-zA-Z0-9-&;]/",'', (setting('site.phone')))}}" class="ast_btn_2 square">{{__('Позвонить')}}<i
