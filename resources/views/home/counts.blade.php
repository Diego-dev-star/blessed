        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6 col-md-4">
                <div class="fact_1 funfact">
                    ...
                    <h2><span class="timer" data-counter="{{setting('homecounts.count1')}}">{{setting('homecounts.count1')}}</span><span>@lang('lang.count1')</span></h2>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-md-4">
                <div class="fact_1 funfact">
                    <i class="sgi sgi-Briefcase"></i>
                    <h2><span class="timer" data-counter="{{setting('homecounts.count2')}}">{{setting('homecounts.count2')}}</span><span>@lang('lang.count2')</span></h2>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-md-4">
                <div class="fact_1 funfact">
                    <i class="sgi sgi-Headset"></i>
                    <h2><span class="timer" data-counter="{{setting('homecounts.count3')}}">{{setting('homecounts.count3')}}</span><span>@lang('lang.count3')</span></h2>
                </div>
            </div>
        </div>
    </div>
