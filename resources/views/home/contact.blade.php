                    ...
                    <form class="" method="post" action="{{url( app()->getLocale().'/contact')}}">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <input type="text" name="con_name" class="required" placeholder="@lang('lang.name')*"/>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <input type="email" name="con_email" class="required" placeholder="@lang('lang.email')*"/>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <input type="text" name="con_company" placeholder="@lang('lang.company')"/>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <input type="text" name="con_phone" placeholder="@lang('lang.phone')"/>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <textarea name="con_message" class="required" placeholder="@lang('lang.message')*"></textarea>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <button type="submit" class="ast_btn" name="con_submit"><span>@lang('lang.send')<i class="sgi sgi-Mail"></i></span></button>
