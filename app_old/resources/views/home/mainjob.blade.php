    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h5 class="sec_sub_title">{{__('Вакансии')}}</h5>
                <h2 class="sec_title">
                    {{__('Тут самые востребованые')}}
                </h2>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-3 col-sm-4 col-md-3">
                ...
                <div class="pj_parcents">
                    ...
                    <div class="pjp_con">
                        ...
                        <h2>{{count($model)}}</h2>
                        <span>{{__('Свободно вакансий')}}</span>
                    </div>
                </div>
            ...
            <div class="col-lg-9 col-sm-8 col-md-9">
                <div class="row work_cus_row shafull_container">
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-6 shaf_item work_cust_padd" data-groups='["all", "{{$job->category}}"]'>
                        <div class="work_loop_1">
                            <div class="wl1_thumb">
                                <img src="{{asset('storage/'.$job->image)}}" alt=""/>
                            </div>
                            <div class="wl1_cont">
                                <p><a href="#">{{$job->category}}</a></p>
                                <h2><a href="{{route('job.show',['id' => $job->id, 'slug' => $job->slug])}}}">{{$job->title}}</a></h2>
                                <div class="wl1_btns">
                ...
                <div class="row mt58">
                    <div class="col-lg-12 text-left">
                        <a href="{{url(app()->getLocale(). '/job')}}" class="ast_btn"><span>{{__('Все вакансии')}}<i class="arrowicon-arrows-2"></i></span></a>
                    </div>
                </div>
            </div>
        </div>
